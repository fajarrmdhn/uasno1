...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Jan 2022 pada 18.30
...
--
-- Struktur dari tabel `tbl_students_0494`
--

CREATE TABLE `tbl_students_0494` (
  `id` int(2) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0494`
--

INSERT INTO `tbl_students_0494` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
